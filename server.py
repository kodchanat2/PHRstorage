...
def nutrientdata():
	...
	if request.method == 'GET':
		...
		# print data
		if client.request_enforcement(watcherid, "read_nutrient", userid, "patient", "*", "*", "*", time_req, "*", appid) :
...
def nutrientImage():
	...
	if client.request_enforcement(watcherid, "read_nutrient_chart", userid, "patient", "*", "*", "*", time_req, "*", appid) :
...
def chartpoint():
	if request.method == 'GET':
		...
		if client.request_enforcement(watcherid, "read_result_chart", userid, "patient", "*", "*", "*", time_req, "*", appid) :
...
def water():
	...
	if client.request_enforcement(watcherid, "read_water", userid, "patient", "*", "*", "*", time_req, "*", appid) :
...
def appointment():
	if request.method == 'POST':
		...
		if client.request_enforcement(watcherid, "read_appointment", userid, "patient", "*", "*", "*", time_req, "*", appid) :
...
def profile():
	if request.method == 'POST':
		...
		if not client.request_enforcement(watcherid, "write_profile", userid, "patient", "*", "*", "*", time_req, "*", appid) :
			return jsonify(success="false", deny="true")
		...
		if client.request_enforcement(watcherid, "read_profile", userid, "patient", "*", "*", "*", time_req, "*", appid) :
			return jsonify(data=data)
		else :
			return jsonify(data={}, deny="true")
...
def exercise():
	if request.method == 'POST':
		...
		if client.request_enforcement(watcherid, "read_exercise", userid, "patient", "*", "*", "*", time_req, "*", appid) :
...
def medicine():
	if request.method == 'POST':
		...
		if not client.request_enforcement(watcherid, "write_medicine", userid, "patient", "*", "*", "*", time_req, "*", appid) :
			return jsonify(success="false", deny="true")
		...
		if client.request_enforcement(watcherid, "read_medicine", userid, "patient", "*", "*", "*", time_req, "*", appid) :
		...
		if not client.request_enforcement(watcherid, "delete_medicine", userid, "patient", "*", "*", "*", time_req, "*", appid) :
			return jsonify(success="false", deny="true")
